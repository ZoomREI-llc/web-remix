    ...
    <div class="ao-testimonials__testimonials">
        <div class="ao-testimonials__testimonial">
            <div class="ao-testimonials__testimonial--content">
                ...
                <blockquote>
                    <p>“In a day and age where professionals in the service industry never seem to answer their phones or return calls, <strong>Doctor Homes promptly responded to my initial call, and was always available during the entire selling process."</strong></p>
                </blockquote>
            </div>
        ...
        <div class="ao-testimonials__testimonial">
            <div class="ao-testimonials__testimonial--content">
                ...
                <blockquote>
                    <p>"<strong>I am quite happy with the easy, fast, stress-free process of dealing with Doctor Homes</strong> I needed to rehab this property that sat vacant too long.</br></br> He made a reasonable offer and the sale went quickly with prompt payment."</p>
                </blockquote>
            </div>
            <div class="ao-testimonials__person">
		...
		<div class="ao-testimonials__testimonial mobile-hide">
			<div class="ao-testimonials__testimonial--content">
				<div class="ao-hero__reviews-stars-wrapper">
					<span class="ao-hero__star"><img src="<?php echo esc_url($star_icon_url); ?>" alt="star"></span>
					<span class="ao-hero__star"><img src="<?php echo esc_url($star_icon_url); ?>" alt="star"></span>
		...
		<div class="ao-testimonials__testimonial mobile-hide">
			<div class="ao-testimonials__testimonial--content">
				...
				<blockquote>
					<p>”Managing a property from out of state became too much, and I needed to sell quickly. Doctor Homes handled everything seamlessly</strong>, and I couldn't be happier with how smoothly the sale went. They truly made it effortless."</p>
				</blockquote>
			</div>
			<div class="ao-testimonials__person">
