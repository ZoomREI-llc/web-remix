...
document.addEventListener("DOMContentLoaded", () => {
  const testimoniels = document.querySelectorAll(".ao-testimonials__testimonial");
  ...
  testimoniels.forEach((faq, index) => {
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(faq, {
      opacity: 0,
      marginBottom: "0%",
      display: "none",
      overflow: "hidden",
    ...
    if (index < flag) {
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(faq, {
        opacity: 1,
        marginBottom: "0%",
        display: "flex",
        duration: 0.5,
