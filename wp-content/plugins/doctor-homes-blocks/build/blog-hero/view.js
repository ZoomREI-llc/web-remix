...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initSlider(carouselWrapper, duration = 0.8, autoplayDuration = 2, autoHeight = false) {
    ...
    let progressWrap = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.wrap(0, 1);
    let numSlides = slides.length;
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(slides, {
      xPercent: i => i * 100
    });
    let wrapX = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.wrap(-100, (numSlides - 1) * 100);
    let timer = autoplayDuration ? gsap__WEBPACK_IMPORTED_MODULE_0__["default"].delayedCall(autoplayDuration, autoPlay) : false;
    let animation = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(slides, {
    ...
    let slideAnimation = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to({}, {});
    let slideWidth = 0;
    let wrapWidth = 0;
    let maxWidth = wrapWidth;
    let widthOneItem = maxWidth / slides.length;
    let prevMW = 0;
    let draggable = new gsap_Draggable__WEBPACK_IMPORTED_MODULE_1__.Draggable(proxy, {
    ...
    function animateSlides(direction) {
      ...
      slideAnimation.kill();
      let x = snapX(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].getProperty(proxy, "x") + direction * slideWidth);
    ...
    function resize() {
      let norm = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].getProperty(proxy, "x") / wrapWidth || 0;
