...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async e => {
    ...
    const formData = {
      ...
      heardAboutUs: form.querySelector('input[name="contact"]:checked') ? form.querySelector('input[name="contact"]:checked').value : null,
      message: messageField.value
    };
    try {
      // Send form data to webhook
      const response = await fetch("https://4b24b890-52bc-43cd-a31a-4917523a9b79.mock.pstmn.io", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#contact-form", {
          duration: 0.5,
          opacity: 0,
          onComplete: () => {
            form.style.display = "none";
            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".contact-form__success", {
              duration: 0.5,
              display: "flex",
              opacity: 1
            });
