...
$faqs = array(
    array(
        ...
        "answer" => "Believe it or not, most sellers we’ve helped in St Louis, Missouri weren’t desperate or facing foreclosure.</br>They come to us because, well, who wants repair headaches or endless showings?</br>We buy houses as they are, no hassle. Get a free, no-obligation cash offer quick and easy!"
    ),
    array(
        "question" => "Why should I choose you?",
        "answer" => "We’re the top home buyers in St Louis, Missouri, found right at the top of Google for a reason. Our customers love us because we deliver what we promise.</br>We’re dedicated to getting you the best cash offer for your house, even if it means connecting you with other trusted buyers.</br>We genuinely care and go the extra mile without expecting anything back."
    ),
    array(
        "question" => "How are you different from a real estate agent?",
        "answer" => "Agents don’t buy your house; they list it, charge fees, and you deal with costs and showings.</br>We’re cash buyers, directly purchasing your house or connecting you with others who do. Skip the agent hassle – get a quick offer and sale in St Louis, Missouri.</br>We cover selling expenses."
    ),
    array(
    ...
    array(
        ...
        "answer" => "We buy homes AS-IS in any condition in St Louis, Missouri.</br>The more the fix-ups, the better for us! Absolutely, we’ll buy your house even if it’s rough. You might be surprised by our offer.</br>Fill out our form and see what cash we’re offering for your house!"
    ),
);
?>
    ...
    <div class="cw-faqs__items">
        <?php foreach ($faqs as $faq) : ?>
            <div class="cw-faqs__item">
                <div class="cw-faqs__question faq-question">
