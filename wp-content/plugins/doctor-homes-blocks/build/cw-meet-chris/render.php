...
$chris_url = plugins_url('src/cw-meet-doctorhomes/assets/meet-person-foto.png', dirname(__FILE__, 2));
$john_url = plugins_url('src/cw-meet-doctorhomes/assets/meet-john-foto.webp', dirname(__FILE__, 2));

// Choose the correct image based on the selected name
$image_url = ($selectedName === 'Chris') ? $chris_url : $john_url;

$fon_url = plugins_url('src/cw-meet-doctorhomes/assets/meet-cris-fon.webp', dirname(__FILE__, 2));
...
<section id='about' class="cw-meet-doctorhomes">
    ...
    <div class="cw-meet-doctorhomes__container">
        <div class="cw-meet-doctorhomes__content">
            <div class="cw-meet-doctorhomes__text">
                ...
                <h2 class="cw-meet-doctorhomes__title">Got A House You Need To Sell In <?php echo esc_html($selectedMarket); ?>?</h2>
            ...
            <div class="cw-meet-doctorhomes__footer-block">
                <a class="cw-meet-doctorhomes__cta" href="#cw-form">Get my offer<img src="<?php echo esc_url($arrow_icon_url); ?>" alt="Arrow"></a>
