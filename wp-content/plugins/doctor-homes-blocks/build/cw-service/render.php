<?php
$ok_icon_Url = plugins_url('src/cw-service/assets/icon-ok--new.svg', dirname(__FILE__, 2));
...
<section id='compare' class="cw-service">
    ...
    <p class="cw-service__text">See how we compare to our competition</p>
    ...
    <div class="cw-service__table">
        <div class="cw-service__row cw-service__row--header">
            ...
            <div class="cw-service__row--centr-item">
                <img src="<?php echo esc_url($logo_url); ?>" alt="logo" class="cw-service__row--icon">
            </div>
