...
/*!*********************************************!*\
  !*** ./src/lcp-as-seen-on-carousel/view.js ***!
  \*********************************************/
// import gsap from "gsap";

function lcpAsSeenOnCarouselCallback() {
  ...
  function cloneLogos() {
    ...
    const logoElements = logos.querySelectorAll(".lcp-as-seen-on-carousel__logo");
...
document.addEventListener("DOMContentLoaded", function () {
  loadScript('https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js', lcpAsSeenOnCarouselCallback);
});
/******/ })()
;
