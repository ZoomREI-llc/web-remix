...
<section class="testimonial-carousel-wrapper">
    <div class="testimonial-carousel-text">
        ...
        <div class="carousel-navigation">
            <button class="carousel-prev" disabled> <?php echo get_responsive_image('lcp-testimonials/navigation-arrow', 'Previous'); ?>
            </button>
            <button class="carousel-next"><?php echo get_responsive_image('lcp-testimonials/navigation-arrow', 'Next'); ?>
            </button>
        </div>
    </div>
                    ...
                    <div class="carousel-item__content">
                        ...
                        <div class="testimonial-rating">
                            <?php for ($i = 0; $i < $testimonial['rating']; $i++) : ?>
                                <?php echo get_responsive_image('lcp-testimonials/star', 'Star Icon', 'testimonial__star'); ?>
                            <?php endfor; ?>
                        </div>
