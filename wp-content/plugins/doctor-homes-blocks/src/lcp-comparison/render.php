...
<section class="lcp-comparison" style="--text-vector: url('<?php echo get_image_url('lcp-comparison/vs-vector', 1024); ?>');">
    ...
    <div class="lcp-comparison-table">
        <div class="lcp-comparison-row header">
            ...
            <div class="lcp-comparison-column doctor-homes">
                <?php echo get_responsive_image('lcp-comparison/logo', 'Doctor Homes'); ?>
            </div>
        ...
        <div class="lcp-comparison-row lcp-comparison-row--uneven">
            ...
            <div class="lcp-comparison-column doctor-homes">
                <div class="column__content">
                    <?php echo get_responsive_image('lcp-comparison/check-mark', ''); ?>
                    <span>None</span>
                </div>
            </div>
            <div class="lcp-comparison-column">
                <div class="column__content">
                    <?php echo get_responsive_image('lcp-comparison/x-mark', ''); ?>
