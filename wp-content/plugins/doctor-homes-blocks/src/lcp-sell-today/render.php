...
<section class="lcp-sell-today">
     <div class="lcp-sell-today__bg">
         <?php echo get_responsive_image('lcp-sell-today/bg', '', 'lcp-sell-today__fon'); ?>
     </div>
        ...
        <div class="lcp-sell-today__content">
            ...
            <div class="lcp-sell-today__reviews">
                <div class="lcp-sell-today__reviews-stars-wrapper">
                    <?php for ($i = 0; $i < 5; $i++): ?>
                        <span class="lcp-sell-today__star"><?php echo get_responsive_image('lcp-sell-today/star', 'star'); ?></span>
                    <?php endfor; ?>
                </div>
