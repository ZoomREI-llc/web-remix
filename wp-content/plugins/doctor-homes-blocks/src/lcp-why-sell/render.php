...
//    $selectedMarket = isset($attributes['selectedMarket']) ? esc_html($attributes['selectedMarket']) : 'Saint Louis';
    $fast = plugins_url('src/lcp-why-sell/assets/fast.svg', dirname(__FILE__, 2));
    $condition = plugins_url('src/lcp-why-sell/assets/condition.svg', dirname(__FILE__, 2));
    $fees = plugins_url('src/lcp-why-sell/assets/fees.svg', dirname(__FILE__, 2));
    $time = plugins_url('src/lcp-why-sell/assets/time.svg', dirname(__FILE__, 2));
?>
<section class="lcp-why-sell">
	<div class="lcp-why-sell__text">
		<h2>Why Sell to Us? <br> No Hassle, Super Flexible, Totally Reliable.</h2>
	</div>
    <div class="lcp-why-sell__grid">
        <div class="lcp-why-sell__item">
            <img src="<?= $fast ?>" alt="Fast">
            <h3>Fast and Hassle-Free</h3>
            <p>Need to sell quickly? Get a cash offer in minutes and sell your house as is fast. No repairs, no commissions, no waiting. With us, you can close within days, making the process quick and stress-free.</p>
        </div>
        <div class="lcp-why-sell__item">
            <img src="<?= $condition ?>" alt="Condition">
            <h3>Sell As-Is in Any Condition</h3>
            <p>No matter the condition, you can sell your house as is fast with us. Avoid costly repairs and get a quick sale. <br> We buy homes in any state, making the process easy and stress-free.</p>
        </div>
        <div class="lcp-why-sell__item">
            <img src="<?= $fees ?>" alt="No fees">
            <h3>No Fees or Commissions</h3>
            <p>Save money with our no fees or commissions policy. Unlike traditional agents, we charge no hidden fees or closing costs. With our cash offers for houses, you keep more money in your pocket without any surprises.</p>
        </div>
        <div class="lcp-why-sell__item">
            <img src="<?= $time ?>" alt="Time">
            <h3>Close on Your Timeline</h3>
            <p>With our flexible timeline, you decide the closing and moving out date. Receive cash offers for houses and get your money quickly. We work around your schedule, ensuring convenience and ease.</p>
        </div>
    </div>
    <div class="lcp-why-sell__bottom">
        <a href="cta-btn #lcp-form" class="btn lcp-why-sell__button">
            Get My Offer
