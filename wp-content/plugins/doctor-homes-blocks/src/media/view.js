...
function mediaCallback() {
  const logosWrapper = document.querySelector(".featured-in__logos-wrapper");
  const logos = document.querySelector(".featured-in__logos");
  ...
  function cloneLogos() {
    ...
    const logoElements = logos.querySelectorAll(".featured-in__logo");
...
document.addEventListener("DOMContentLoaded", function () {
  loadScript('https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js', mediaCallback)
});