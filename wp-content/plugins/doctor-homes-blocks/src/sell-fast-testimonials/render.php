...
<section class="testimonial-carousel-wrapper">
    <div class="testimonial-carousel-text">
        ...
        <div class="carousel-navigation">
            <button class="carousel-prev" disabled> <?php echo get_responsive_image('sell-fast-testimonials/navigation-arrow', 'Previous'); ?>
            </button>
            <button class="carousel-next"><?php echo get_responsive_image('sell-fast-testimonials/navigation-arrow', 'Next'); ?>
            </button>
        </div>
    </div>
