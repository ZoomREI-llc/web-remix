...
$testimonials = [
    [
        'name' => 'Nataly Lebedev',
        'image' => wp_get_attachment_url(101),
    ...
    [
        'name' => 'Shaked Elnatan',
        'image' => wp_get_attachment_url(103),
    ...
    [
        'name' => 'Darren Pilch',
        'image' => wp_get_attachment_url(98),
    ...
    [
        'name' => 'Liv Skyler ',
        'image' => wp_get_attachment_url(100),
    ...
    [
        'name' => 'Leigh Williams',
        'image' => wp_get_attachment_url(99),
    ...
    <div class="testimonial-carousel">
        <?php foreach ($testimonials as $index => $testimonial) : ?>
            <div class="testimonial">
                <img src="<?php echo esc_url($testimonial['image']); ?>" alt="<?php echo esc_attr($testimonial['name']); ?>" class="testimomonial__image">
                <p><?php echo esc_html($testimonial['text']); ?></p>
                <p class="testimonial-name"><?php echo esc_html($testimonial['name']); ?></p>
                <div class="testimonial-rating">
                    <?php for ($i = 0; $i < $testimonial['rating']; $i++) : ?>
                        <img src="<?php echo esc_url($star_icon_url); ?>" alt="star" class="testimomonial__star">
                    <?php endfor; ?>
                </div>
            </div>
        <?php endforeach; ?>
